 ...
 * 
 * Displays credibility metrics and partner school logos.
 * Uses scroll-triggered animations for engagement.
 * 
 * Content:
 * - Section headline emphasizing school partnerships
 * - Row of school logos (grayscale, colored on hover)
 * - 4 key statistics in a responsive grid
 */

import { motion, useInView } from "framer-motion";
import { useRef } from "react";

// School logo imports - stored in src/assets/logos/
...
// Statistics to display - value and label pairs
const STATS = [
...
// Partner school logos with alt text for accessibility
const SCHOOL_LOGOS = [
...
const StatsSection = () => {
  // Ref for scroll-trigger detection
  const ref = useRef(null);
  // Triggers animation when section is 100px into viewport (once only)
